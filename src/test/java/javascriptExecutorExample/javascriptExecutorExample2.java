...
//		WebElement ele1 = driver.findElement(By.cssSelector("[name=\"lname\"]"));
...
//		JS.executeScript("arguments[0].value='enter last name'"   ,    ele , ele1, "enter last name......", "enter last name");
		
		JS.executeScript("arguments[0].value=arguments[1]"   ,    ele , "enter last name......", "enter last name");
		
		
//		JS.executeScript("arguments[0].value='arguments[1]'", ele, "enter value");
